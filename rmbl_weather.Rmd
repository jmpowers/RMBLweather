...
summary_names <- c(snow_free_days = "Snowmelt to first permanent snowfall",
                   max_drought_days_2mm="Longest drought (< 2 mm precipitation)", 
                   rain_days_2mm = "Rainy days (> 2 mm precipitation)",
                   prop_rain_days_2mm = "Proportion rainy days (> 2 mm precipitation)",
                   max_precip_mm = "Maximum daily precipitation (mm)",
                   avg_precip_mm = "Average daily precipitation (mm)",
